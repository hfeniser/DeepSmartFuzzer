...
from cifar_experiment import cifar_experiment
import numpy as np

# args, (train_images, train_labels), (test_images, test_labels), model, coverage, input_chooser = mnist_lenet_experiment(
#     "mcts")

args, (train_images, train_labels), (test_images, test_labels), model, coverage, input_chooser = cifar_experiment(
    "mcts")
