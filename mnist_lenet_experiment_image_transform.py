...
env_id = 'mnist-transform-v1'
register_dnn_test_env_from_config(env_id, env_config, entry_point='gym_dnn_test.envs:DNN_Test_Image_Transforms')
env = gym.make('gym_dnn_test:mnist-transform-v1')
