...
class SurpriseAdequacy:
    ...
    def test(self, test_inputs, instance='dsa'):
        ...
        if instance  == 'lsa':
            ...
            target_cov = get_sc(np.amin(target_dsa), self.upper_bound,
