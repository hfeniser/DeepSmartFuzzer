...
from new_coverages.kmn import DeepGaugePercentCoverage
coverage2 = DeepGaugePercentCoverage(model, k, train_inputs=train_images.reshape(-1, 28, 28, 1))
...
print("1coverage:", (coverage.get_current_coverage(), coverage2.get_current_coverage()))
print("1a:", (a, b))



a = coverage.step(test2.reshape(-1,28,28,1), update_state=True)
b = coverage2.step(test2.reshape(-1,28,28,1), update_state=True)
print("2coverage: ", (coverage.get_current_coverage(), coverage2.get_current_coverage()))
print("2a: ", (a, b))
...
print("3coverage: ", (coverage.get_current_coverage(), coverage2.get_current_coverage()))
print("3a: ", (a, b))